...
class TestReservation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with self.app.test_request_context():
            ...
            self.restaurant = Restaurant.update(self.operator.restaurant_id, tables)
    ...
    def test_get_reservations(self):
        with self.app.app_context():
            ...
            r = Reservation.get_paged_reservation_of_today(-1, 1)
            self.assertIsNone(r)

            r = Reservation.get_paged_reservations(-1, 1)
            self.assertIsNone(r)
